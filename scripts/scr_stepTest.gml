...
with(instance_create(x,y,obj_ship)){//show_debug_message('defenseur')
...
/*if planetnowid = buildaffect{
    with(obj_highscore){
        ...
        ds_map_set(hiscore_map,'sc1', ds_grid_get(obj_planetary.planetary,231,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc2', ds_grid_get(obj_planetary.planetary,232,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc3', ds_grid_get(obj_planetary.planetary,233,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc4', ds_grid_get(obj_planetary.planetary,234,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc5', ds_grid_get(obj_planetary.planetary,235,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc6', ds_grid_get(obj_planetary.planetary,236,obj_planetary.planetnowid));
        ds_map_set(hiscore_map,'sc7', ds_grid_get(obj_planetary.planetary,237,obj_planetary.planetnowid));
