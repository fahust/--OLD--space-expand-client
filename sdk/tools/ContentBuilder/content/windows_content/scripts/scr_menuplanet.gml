...
draw_set_color(c_white);
draw_text_outline(xxmenulerp+xdisthealth-xplus,300,"Lore",planetarycolor2,room_width,fa_bottom,20,true)
    
}

//MISSION QUEST ET REPUTATION
if statschoosemenu = 6 {//ships
draw_set_color(planetarycolor2);
if device_mouse_check_button(0, mb_left){
xxmousefin = device_mouse_x(0);
yymousefin = device_mouse_y(0);}
...
draw_text_outline(xxmenulerp+xdisthealth-xplus,350+ytext-(roll*4),"Quest Title : "+string_add_delimiter(ds_grid_get(planetary,36,planetnowid)),planetarycolor,room_width,fa_bottom,20,false)
draw_text_outline(xxmenulerp+xdisthealth-xplus,400+ytext-(roll*4),"Quest faction : "+string_add_delimiter(ds_grid_get(planetary,36,planetnowid)),planetarycolor,room_width,fa_bottom,20,false)
draw_text_outline(xxmenulerp+xdisthealth-xplus,450+ytext-(roll*4),"Quest description : "+string_add_delimiter(ds_grid_get(planetary,36,planetnowid)),planetarycolor,room_width,fa_bottom,20,false)
draw_text_outline(xxmenulerp+xdisthealth-xplus,500+ytext-(roll*4),"Ressource needed : "+string_add_delimiter(ds_grid_get(planetary,36,planetnowid)),planetarycolor,room_width,fa_bottom,20,false)
draw_text_outline(xxmenulerp+xdisthealth-xplus,550+ytext-(roll*4),"Ships needed : "+string_add_delimiter(ds_grid_get(planetary,36,planetnowid)),planetarycolor,room_width,fa_bottom,20,false)
...
draw_rectangle(widthor0+xxmenulerp,275,room_width+xxmenulerp,340,false);
draw_set_color(c_white);
draw_text_outline(xxmenulerp+xdisthealth-xplus,300,"Quest",planetarycolor2,room_width,fa_bottom,20,true)
...
if portrait = 0 {
if  point_distance(xxmouse,yymouse,room_width-(room_width/12)-300,(room_height/25)) < 25 {colorrect9 = c_white
if device_mouse_check_button_pressed(0, mb_left) && xxmenulerp < 1 { statschoosemenu = 5;roll=0;}}
draw_sprite_ext(spr_stats,6,xxmenulerp+room_width-(room_width/12)-300,(room_height/25),0.3,0.3,0,colorrect9,1)
if  point_distance(xxmouse,yymouse,room_width-(room_width/12)-300,(room_height/25)+100) < 25 {colorrect10 = c_white
if device_mouse_check_button_pressed(0, mb_left) && xxmenulerp < 1 { statschoosemenu = 6;roll=0;}}
draw_sprite_ext(spr_quest,0,xxmenulerp+room_width-(room_width/12)-300,(room_height/25)+100,0.7,0.7,0,colorrect10,1)

}else{
if  point_distance(xxmouse,yymouse,room_width-(room_width/12)-100,(room_height/25)) < 25 {colorrect9 = c_white
if device_mouse_check_button_pressed(0, mb_left) && xxmenulerp < 1 { statschoosemenu = 5;roll=0;}}
draw_sprite_ext(spr_stats,6,xxmenulerp+room_width-(room_width/12)-100,(room_height/25),0.3,0.3,0,colorrect9,1)
if  point_distance(xxmouse,yymouse,room_width-(room_width/12)-100,(room_height/25)+100) < 25 {colorrect10 = c_white
if device_mouse_check_button_pressed(0, mb_left) && xxmenulerp < 1 { statschoosemenu = 6;roll=0;}}
draw_sprite_ext(spr_quest,0,xxmenulerp+room_width-(room_width/12)-100,(room_height/25)+100,0.7,0.7,0,colorrect10,1)
...
if portrait = 0 {
    if planetnowid != 0 {colorBioIcon = planetarycolor2;
